// 引入 Firebase 配置和功能模块
import { initializeApp } from "https://unpkg.com/firebase@9.23.0/firebase-app.js";
import {
  getFirestore,
  collection,
  addDoc,
  ...
  doc,
  serverTimestamp,
} from "https://unpkg.com/firebase@9.23.0/firebase-firestore.js";
import { getAuth, onAuthStateChanged } from "https://unpkg.com/firebase@9.23.0/firebase-auth.js";
...
const firebaseConfig = {
  ...
  storageBucket: "chenyu-harris-project.appspot.com",  // 确保正确的 storageBucket
...
// 页面加载时初始化 Firebase 服务和建议列表
document.addEventListener("DOMContentLoaded", async () => {
  await initializeServices(); // 确保 Firebase 服务已初始化
  if (auth) {
    setupAuthListener(); // 设置身份验证监听
  }
  loadSuggestions();
});
